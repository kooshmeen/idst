...
async def on_member_join(member):
    ...
    await member.dm_channel.send(f'Salut {member.name} eu sunt Puya ya ya sus pe bar!')
...
async def on_message(msg):
    ...
    if msg.author == bot.user:
        return
    if msg.content == 'puya':
        await msg.channel.send('ia zi frate')
    if msg.content == 'salut puya':
        await msg.channel.send('salut sunt puya')
